...
class _TasbihScreenState extends State<TasbihScreen>
  ...
  int _counter = 0;
  int _totalCounter = 0;
  String _currentTasbih = 'سُبْحَانَ اللَّهِ';
          ...
          appBar: AppBar(
            title: Column(
              ...
              children: [
                ...
                Text(
                  'تَسْبِيحَات تُرَدَّد بِهُدُوء… وَمَعَ حُضُور الْقَلْب'
                      .preventOrphan(),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // Suggestion Carousel
                    Text(
                      'اخْتَارِي ذِكْرَكِ'.preventOrphan(),
                    ...
                    Container(
                      ...
                      child: Text(
                        'رَصِيدُكِ مِنَ التَّسْبِيحِ: $_totalCounter',
                        style: AppTypography.arabic(fontSize: 16).copyWith(
                          color: const Color(0xFFC09D63),
                          fontWeight: FontWeight.bold,
                        ),
