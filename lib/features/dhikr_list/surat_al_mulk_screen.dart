...
class _SuratAlMulkScreenState extends State<SuratAlMulkScreen> {
  ...
  void _zoomIn() {
    setState(() {
      if (fontSizeMultiplier < 1.2) fontSizeMultiplier += 0.2;
    });
    // Haptic removed
  }
  ...
  List<InlineSpan> _buildStyledText(String text, Color primaryColor) {
      ...
      builder: (context, _) {
        ...
        return ScaffoldWithBackground(
          ...
          body: SingleChildScrollView(
            padding: const EdgeInsets.fromLTRB(8, 20, 8, 60),
            child: Column(
              children: [
