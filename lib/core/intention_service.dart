...
class IntentionService extends ChangeNotifier {
  ...
  final List<Intention> _intentions = [
    ...
    Intention(
      title: 'السَّكِينَةُ وَالطُّمأْنِينَةُ',
      description:
          'أُجَدِّدُ نِيَّتِي فِي أَنْ يَكُونَ يَوْمِي كُلُّهُ عِبَادَةً وَسَكِينَةً، أَسْتَعِينُ بِاللَّهِ عَلَى ضَجِيجِ الدُّنْيَا، وَأَجْعَلُ مِنْ عَمَلِي طَرِيقًا لِلْقُرْبِ مِنْهُ سُبْحَانَهُ.',
    ),
  ];
