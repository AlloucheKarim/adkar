...
class IntentionService extends ChangeNotifier {
  ...
  final List<Intention> _intentions = [
    ...
    Intention(
      ...
      description:
          'اللَّهُمَّ إِنِّي أَتَوَكَّلُ عَلَيْكَ فِي سَعْيِي وَرِزْقِي، نَاوِيَةً بَذْلَ السَّبَبِ مَعَ تَعَلُّقِ قَلْبِي بِكَ وَحْدَكَ، اللَّهُمَّ اجْعَلْ بَرَكَتَكَ وَفَضْلَكَ يُحِيطَانِ بِكُلِّ جُهْدٍ أَبْذُلُهُ.',
    ),
    Intention(
