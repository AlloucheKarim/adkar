...
class AppTypography {
  static TextStyle header({Color? color, double fontSize = 28}) => GoogleFonts.notoNaskhArabic(
        fontSize: fontSize,
  ...
  static TextStyle uiBody({Color? color, double fontSize = 16, FontWeight? fontWeight}) =>
  ...
  static TextStyle arabic({Color? color, double fontSize = 28}) => GoogleFonts.notoNaskhArabic(
        fontSize: fontSize,
        height: 1.8,
        color: color ?? AppColors.textPrimary,
      );
